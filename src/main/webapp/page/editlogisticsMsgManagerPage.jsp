    ...
    <div class="left content0718">
        <div class="column-content0718">
					...
					<div class="leftList">
						...
						<table cellpadding="5" class="right0407">
							...
							<tr>
								...
								<td><input class="easyui-datebox" type="text" name="exp6Str" id="exp6" data-options="novalidate:true" style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-combobox" type="text" name="logisticsStatus"  id="logisticsStatus"
										   data-options="novalidate:true"		   style="width: 200px"/>
								</td>
							...
							<tr>
								...
								<td><input class="easyui-numberbox" type="text" name="logisticeFee" precision="2"
										   data-options="novalidate:true"		   style="width: 200px"/>
								</td>
								<td class="text_left width0407">运费</td>
								<td><input class="easyui-numberbox" type="text" name="freightFee" precision="2"
										   style="width: 200px" data-options="novalidate:true"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="operationCostFee" precision="2"
										   style="width: 200px"
										   data-options="validType:['maxLength[50]'],novalidate:true"/>
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="otherFee" precision="2"
										   data-options="novalidate:true"		   style="width: 200px"/>
								</td>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsMsgManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsMsgManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editlogisticsMsgManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditlogisticsMsgManagerPage.init();
</script>
</body>
</html>