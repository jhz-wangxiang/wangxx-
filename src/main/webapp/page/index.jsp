                ...
                <div class="left ">
                    <table cellpadding="5" class="right">
                        ...
                        <tr>
                            ...
                            <td><input class="textbox" type="text" name="userNo" data-options="validType:['illegalCharacter','maxLength[50]'],novalidate:true"/>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="left">
                    <table cellpadding="5" class="right">
                        ...
                        <tr>
                            ...
                            <td><select class="easyui-combobox" id="afterState" data-options="editable:false,url:'<%=basePath %>v1/managervar/querySysEnum?enumCode=REFUND_STATE',valueField:'value',textField:'name',panelHeight:'auto', value:'--请选择--' "></select>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="left">
                    <table cellpadding="5" class="right">
                        ...
                        <tr>
                            ...
                            <td><select class="easyui-combobox" id="exStatus" data-options="editable:false,url:'<%=basePath %>v1/managervar/querySysEnum?enumCode=EX_STATUS',valueField:'value',textField:'name',panelHeight:'auto', value:'--请选择--' "></select>
                            </td>
                        </tr>
                    </table>
                </div>
...
<div id="table-show-condition-window" class="" title="选择显示信息">
    ...
    <li><label for="condition_No"><input type="checkbox" id="condition_No" value="No" name="" class="check"/>序号</label>
    <li><label for="condition_orderNo"><input type="checkbox" id="condition_orderNo" value="orderNo" name="" class="check"/>订单号</label></li>
    <li><label for="condition_userNo"><input type="checkbox" id="condition_userNo" value="userNo" name="" class="check"/>会员ID</label></li>
    ...
    <li><label for="condition_orderOriginalPrice"><input type="checkbox" id="condition_orderOriginalPrice" value="orderOriginalPrice" name="" class="check"/>应付总额(总)</label></li>
    <li><label for="condition_payment"><input type="checkbox" id="condition_payment" value="payment" name="" class="check"/>支付方式</label></li>
    <li><label for="condition_wxTransactionNo"><input type="checkbox" id="condition_wxTransactionNo" value="wxTransactionNo" name="" class="check"/>交易单号</label>
    <li><label for="condition_invoiceType"><input type="checkbox" id="condition_invoiceType" value="invoiceType" name="" class="check"/>发票类型</label>
    ...
    <li><label for="condition_orderStatus"><input type="checkbox" id="condition_orderStatus" value="orderStatus" name="" class="check"/>订单状态</label></li>
    	...
    	<li><label for="condition_productPrice"><input type="checkbox" id="condition_pice" value="pice" name="" class="check"/>单价</label></li>
    	...
    	<li><label for="condition_orderPayablePrice"><input type="checkbox" id="condition_orderPayablePrice" value="orderPayablePrice" name="" class="check"/>实付金额（总）</label></li>
    	...
    	<li><label for="condition_afterSaleState"><input type="checkbox" id="condition_refundStatus" value="refundStatus" name="" class="check"/>退换货状态</label></li>
    	<li><label for="condition_marketingId"><input type="checkbox" id="condition_marketingId" value="marketingId" name="" class="check"/>优惠ID1</label></li>
    	<li><label for="condition_discountId"><input type="checkbox" id="condition_discountId" value="discountId" name="" class="check"/>优惠ID2</label></li>
    </ul>
    <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;">
		<a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" href="javascript:void(0)" onclick="Index.table_condition()">提交</a>
