    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    ...
                    <a class="btn reset-btn0718"  href="<%=basePath %>/v1/lLogisticsManagerController/logisticsSettlementManagerPage">结算信息</a>
            ...
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsSettlementManagerPage.importExcel(this)"/>
        ...
        <div class="column-content0718">
        	<div class=" content-tool0718 clearfix">
        		...
        		<a href="javascript:LogisticsSettlementManagerPage.searchDataBySystemManageOrder();" class="btn search-btn0718 excle-btn0405 left">搜索</a>
...
<div id="table-show-condition-window"  title="选择显示信息">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'">
            ...
            <div class="displayBox">
                ...
                <ul id="orderCkUl">
                    ...
                    <li><input type="checkbox" id="systemManageOrder1" value="systemManageOrder" name="check0407" class="check"/>系统管理订单号</li>
            ...
            <div class="displayBox">
                ...
                <ul id="wuLiuCkUl">
                    ...
                    <input type="hidden" name="wuLiu0407" value="6">
                </ul>
            </div>
            <div class="displayBox">
                ...
                <ul id="moneyCkUl">
                    ...
                    <li><input type="checkbox" id="ynSettlement" value="ynSettlement" name="check0407" class="check" checked/>是否结算</li>
                    <li><input type="checkbox" id="costCalculationDate" value="costCalculationDate" name="check0407" class="check" checked/>费用计算日期</li>
                    <li><input type="checkbox" id="exp10" value="exp10" name="check0407" class="check" checked/>是否理赔</li>
                    <li><input type="checkbox" id="exp11" value="exp11" name="check0407" class="check" checked/>理赔原因</li>
                    <li><input type="checkbox" id="exp12" value="exp12" name="check0407" class="check" checked/>理赔状态</li>
                    ...
                    <input type="hidden" name="money0407" value="5">
                </ul>
            </div>
            <div class="displayBox">
            ...
            <div class="displayBox">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    ...
                    <li><input type="checkbox" id="exp29" value="exp29" name="check0407" class="check" checked/>自定义9</li>
                    <li><input type="checkbox" id="exp30" value="exp30" name="check0407" class="check" checked/>自定义10</li>
        ...
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsSettlementManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsSettlementManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsSettlementManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsSettlementManagerPage.init();
