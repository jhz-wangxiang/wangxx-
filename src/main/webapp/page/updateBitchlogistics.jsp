    ...
    <div class="left content0718">
        <div class="column-content0718">
				...
				<div class="left">
					<div class="leftList">
						...
						<table cellpadding="5" class="right0407" >
							<tr>
								<td class="text_left width0407 ">订单日期</td>
								<td><input class="easyui-datebox" type="text" name="orderDateStr" id="orderDate"
										   data-options="editable:false,novalidate:true" style="width: 200px"/>
								</td>
								<td class="text_left width0407 ">发货类型</td>
							...
							<tr>
								<td class="text_left width0407 ">客户名称</td>
								<td><input class="easyui-textbox" type="text" name="customerName"
										   data-options="validType:['maxLength[100]'],novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 ">系统管理订单号</td>
								<td><input class="easyui-textbox" type="text" name="systemManageOrder"
										   data-options="validType:['maxLength[100]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							...
							<tr>
								<td class="text_left width0407 ">产品编码</td>
								<td><input class="easyui-textbox" type="text" name="productCode"
										   data-options="validType:['maxLength[100]'],novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 ">产品名称</td>
								<td><input class="easyui-textbox" type="text" name="producutName"
							...
							<tr>
								...
								<td class="text_left width0407 ">发货数量</td>
								<td><input class="easyui-numberbox" type="text" name="sendGoodsNum"
							...
							<tr>
								<td class="text_left width0407 ">收货人姓名（一）</td>
								<td><input class="easyui-textbox" type="text" name="consigneeName1"
										   data-options="validType:['maxLength[50]'],novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 ">收货人电话（一）</td>
							...
							<tr>
								...
								<td><input class="easyui-datebox" type="text" name="exp6Str" id="exp6"
										   data-options="novalidate:true" style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="exp39"
										   data-options="novalidate:true" style="width: 200px"/>
								</td>
								<td class="text_left width0407">业务员</td>
								<td><input class="easyui-textbox" type="text" name="exp40"
										   data-options="novalidate:true" style="width: 200px"/>
								</td>
							</tr>
						</table>
					...
					<div class="leftList marTop20">
						...
						<table cellpadding="5" class="right0407">
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticsNumber"
										   data-options="validType:['maxLength[50]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticeFee" readonly
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">运费</td>
								<td><input class="easyui-numberbox" type="text" name="freightFee" precision="2"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">中转费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="transitFee"
										   data-options="novalidate:true"      style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="packingChargesFee"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">送货上门</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="provideHomeFee"
										   data-options="novalidate:true"      style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">上楼费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="upstairsFee"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">代收货款</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="collectMoney"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">超派费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="superChargeFee"
										   data-options="novalidate:true"      style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">提货费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="deliveryFee"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">拒收退回费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="rejectionFee"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="otherFee"
										   data-options="novalidate:true"   	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsOrderManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsOrderManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editlogisticsOrderManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditlogisticsOrderManagerPage.init();
</script>
</body>
</html>