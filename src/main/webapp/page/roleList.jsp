...
<script type="text/javascript">
	var menuArr = [{exp1:"订单列表",menuId:"1"},{exp1:"新建订单",menuId:"2"},{exp1:"异常订单",menuId:"3"},{exp1:"客户账号",menuId:"4"},{exp1:"员工管理",menuId:"5"},{exp1:"角色管理",menuId:"6"},{exp1:"渠道管理",menuId:"7"},{exp1:"航班管理",menuId:"8"},{exp1:"区域管理",menuId:"9"}];
    var colArr = [
