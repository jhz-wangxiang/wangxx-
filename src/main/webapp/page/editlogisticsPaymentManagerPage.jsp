    ...
    <div class="left content0718">
        <div class="column-content0718">
					...
					<div class="leftList">
						...
						<table cellpadding="5" class="right0407">
							<tr class="lot-tr0606">
								...
								<td><input class="easyui-combobox" type="text" name="sendGoodsType" data-options="novalidate:true" id="sendGoodsType"
							...
							<tr class="lot-tr0606">
								...
								<td><input class="easyui-numberbox" type="text" name="deposit" readonly
										   data-options="novalidate:true"   style="width: 200px"/>
								</td>
							...
							<tr class="lot-tr0606">
								...
								<td class="text_left width0407 redColor">订单状态</td>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsPaymentManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsPaymentManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editlogisticsPaymentManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditlogisticsPaymentManagerPage.init();
</script>
</body>
</html>