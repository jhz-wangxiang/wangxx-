    ...
    <div class="left content0718">
        <div class="column-content0718">
						...
						<table cellpadding="5" class="right0407" >
							...
							<tr>
								...
								<td><input class="easyui-numberbox" type="text" name="sendGoodsNum"
										   data-options="required:true,max:999999999.99,validType:['maxNumLength[12]']"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
						...
						<table cellpadding="5" class="right0407">
							...
							<tr>
								...
								<td><input class="easyui-datebox" type="text" name="collectionDateStr"
										   id="collectionDate" data-options="editable:false" style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-datebox" type="text" name="costCalculationDateStr"
										   id="costCalculationDate" data-options="editable:false" style="width: 200px"/>
								</td>
							</tr>
							<tr>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditLlogisticsManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditLlogisticsManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editLlogisticsManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditLlogisticsManagerPage.init();
</script>
</body>
</html>