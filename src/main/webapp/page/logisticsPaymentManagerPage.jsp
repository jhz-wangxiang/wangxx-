    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    ...
                    <a class="btn reset-btn0718" href="<%=basePath %>v1/lLogisticsManagerController/logisticsPaymentManagerPage">回款信息</a>
            ...
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsPaymentManagerPage.importExcel(this)"/>
        ...
        <div class="column-content0718">
        	<div class=" content-tool0718 clearfix">
        		...
        		<a href="javascript:LogisticsPaymentManagerPage.searchDataBySystemManageOrder();" class="btn search-btn0718 excle-btn0405 left">搜索</a>
...
<div id="table-show-condition-window"  title="选择显示信息">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'">
            ...
            <div class="displayBox">
                ...
                <ul id="wuLiuCkUl">
                    ...
                    <input type="hidden" name="wuLiu0407" value="1">
                </ul>
            </div>
            <div class="displayBox">
                ...
                <ul id="moneyCkUl">
                    ...
                    <li><input type="checkbox" id="collectionPrice" value="collectionPrice" name="check0407" class="check" checked/>回款金额</li>
                    <li><input type="checkbox" id="collectionDate" value="collectionDate" name="check0407" class="check" checked/>回款日期</li>
                    ...
                    <input type="hidden" name="money0407" value="3">
                </ul>
            </div>
            <div class="displayBox">
            ...
            <div class="displayBox">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    ...
                    <li><input type="checkbox" id="exp27" value="exp27" name="check0407" class="check" checked/>自定义7</li>
                    <li><input type="checkbox" id="exp28" value="exp28" name="check0407" class="check" checked/>自定义8</li>
        ...
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsPaymentManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsPaymentManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsPaymentManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsPaymentManagerPage.init();
