    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    <a class="btn reset-btn0718" href="<%=basePath %>v1/lLogisticsManagerController/logisticsManagerPage">汇总订单</a>
            ...
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsManagerPage.importExcel(this)"/>
        ...
        <div data-options="region:'center'">
            ...
            <div class="displayBox selBox0516">
                ...
                <ul id="orderCkUl">
                    ...
                    <li><input type="checkbox" id="systemOrder" value="systemOrder" name="check0407" class="check" checked/>系统订单号</li>
                    <li><input type="checkbox" id="platformOrder" value="platformOrder" name="check0407" class="check" checked/>平台订单编号</li>
                    ...
                    <input type="hidden" name="order0407" value="8">
                </ul>
            </div>
            <div class="displayBox selBox0516">
            ...
            <div class="displayBox selBox0516">
                ...
                <ul id="moneyCkUl">
                    ...
                    <li><input type="checkbox" id="ynPayment" value="ynPayment" name="check0407" class="check" checked/>是否回款</li>
                    ...
                    <input type="hidden" name="money0407" value="2">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="addressCkUl">
                    ...
                    <input type="hidden" name="address0407" value="2">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    ...
                    <input type="hidden" name="defined0407" value="0">
                </ul>
            </div>
        </div>
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsManagerPage.init();
</script>
</body>
</html>