    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    <a class="btn search-btn0718 new-btn0405"  href="<%=basePath %>v1/lLogisticsManagerController/logisticsManagerPage">汇总订单</a>
                    <a class="btn reset-btn0718" href="<%=basePath %>v1/lLogisticsManagerController/logisticsOrderManagerPage">订单信息</a>
            ...
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsOrderManagerPage.importExcel(this)"/>
        ...
        <div class="column-content0718">
        	<div class=" content-tool0718 clearfix">
        		...
        		<a href="javascript:LogisticsOrderManagerPage.searchDataBySystemManageOrder();" class="btn search-btn0718 excle-btn0405 left">搜索</a>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'">
            ...
            <div class="displayBox selBox0516">
                ...
                <p style="margin-top:10px;"><input type="checkbox" id="orderCk" name="orderCkUl" class="check" checked/>全选</p>
                <ul id="orderCkUl">
                    <li><input type="checkbox" id="orderDate" value="orderDate" name="check0407" class="check" checked/>订单日期</li>
                    <li><input type="checkbox" id="sendGoodsType" value="sendGoodsType" name="check0407" checked class="check"/>发货类型</li>
                    <li><input type="checkbox" id="customerName" value="customerName" name="check0407" checked class="check"/>客户名称</li>
                    <li><input type="checkbox" id="systemManageOrder1" value="systemManageOrder" name="check0407" class="check" checked/>系统管理订单号</li>
                    <li><input type="checkbox" id="systemOrder" value="systemOrder" name="check0407" checked class="check"/>系统订单号</li>
                    <li><input type="checkbox" id="platformOrder" value="platformOrder" name="check0407" checked class="check"/>平台订单编号</li>
                    <li><input type="checkbox" id="clientProperty1" value="clientProperty" name="check0407" checked class="check"/>客户属性</li>
                    <li><input type="checkbox" id="orderType" value="orderType" name="check0407" class="check" checked/>订单类型</li>
                    ...
                    <li><input type="checkbox" id="exp7" value="exp7" name="check0407" class="check" checked/>产品分类</li>
                    <li><input type="checkbox" id="accountingUnit" value="accountingUnit" name="check0407" class="check" checked/>核算单位</li>
                    <li><input type="checkbox" id="exp15" value="exp15" name="check0407" class="check" checked/>礼品情况</li>
                    ...
                    <li><input type="checkbox" id="remarks" value="remarks" name="check0407" class="check" checked/>备注</li>
                    <li><input type="checkbox" id="deposit" value="deposit" name="check0407" class="check" checked/>定金</li>
                    <li><input type="checkbox" id="ynPaymentReceived" value="ynPaymentReceived" name="check0407" class="check" checked/>是否代收货款</li>
                    <li><input type="checkbox" id="returnGoodsNosentOrder" value="returnGoodsNosentOrder" name="check0407" class="check" checked/>退货补发对应订单号</li>
                    <li><input type="checkbox" id="orderDecision" value="orderDecision" name="check0407" class="check" checked/>订单判定</li>
                    <li><input type="checkbox" id="exp6" value="exp6" name="check0407" class="check" checked/>出货时间</li>
                    <li><input type="checkbox" id="exp39" value="exp39" name="check0407" class="check" checked/>部门</li>
                    <li><input type="checkbox" id="exp40" value="exp40" name="check0407" class="check" checked/>业务员</li>
                    <input type="hidden" name="order0407" value="24">
                </ul>
            </div>
            <div class="displayBox selBox0516">
            ...
            <div class="displayBox selBox0516">
                ...
                <ul id="moneyCkUl">
                    <li><input type="checkbox" id="orderStatus1" value="orderStatus" name="check0407" class="check"/>订单状态</li>
            ...
            <div class="displayBox selBox0516">
                ...
                <p style="margin-top:10px;"><input type="checkbox" id="addressCk" name="addressCkUl" class="check" checked/>全选</p>
                <ul id="addressCkUl">
                    <li><input type="checkbox" id="consigneeName1" value="consigneeName1" name="check0407" class="check" checked/>收货人姓名（一）</li>
                    <li><input type="checkbox" id="consigneephone1" value="consigneephone1" name="check0407" class="check" checked/>收货人电话（一）</li>
                    <li><input type="checkbox" id="consigneeName2" value="consigneeName2" name="check0407" class="check" checked/>收货人姓名（二）</li>
                    <li><input type="checkbox" id="consigneephone2" value="consigneephone2" name="check0407" class="check" checked/>收货人电话（二）</li>
                    <li><input type="checkbox" id="receivingProvince" value="receivingProvince" name="check0407" class="check" checked/>收货省</li>
                    <li><input type="checkbox" id="receivingCityCounty" value="receivingCityCounty" name="check0407" class="check" checked/>收货地级市/县</li>
                    <li><input type="checkbox" id="cityLevel" value="cityLevel" name="check0407" class="check" checked/>城市级别</li>
                    <li><input type="checkbox" id="addressDetail" value="addressDetail" name="check0407" class="check" checked/>收货详细地址</li>
                    <input type="hidden" name="address0407" value="8">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    <li><input type="checkbox" id="exp21" value="exp21" name="check0407" class="check" checked/>自定义1</li>
                    <li><input type="checkbox" id="exp22" value="exp22" name="check0407" class="check" checked/>自定义2</li>
        ...
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsOrderManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsOrderManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsOrderManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsOrderManagerPage.init();
