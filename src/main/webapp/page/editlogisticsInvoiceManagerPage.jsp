    ...
    <div class="left content0718">
        <div class="column-content0718">
					...
					<div class="leftList">
						...
						<table cellpadding="5" class="right0407">
							<tr class="lot-tr0606">
								...
								<td><input class="easyui-datebox" type="text" name="orderDateStr" id="orderDate" style="width: 200px" readonly/>
								</td>
							...
							<tr>
								<td class="text_left width0407 redColor">单价</td>
								<td><input class="easyui-numberbox" type="text" name="unitPrice" id="unitPrice" readonly style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">金额</td>
								<td><input class="easyui-numberbox" type="text" name="price" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr>
					...
					<div class="leftList" style="display: none">
						...
						<table cellpadding="5" class="right0407">
							...
							<tr>
								...
								<td><input class="easyui-datebox" type="text" name="exp6Str" id="exp6" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407 redColor" >物流公司</td>
								<td><input class="easyui-textbox" type="text" name="logisticsCompany" readonly style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">物流单号</td>
								<td><input class="easyui-textbox" type="text" name="logisticsNumber" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-numberbox" type="text" name="freightFee" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407 redColor">中转费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="transitFee" readonly style="width: 200px" data-options="novalidate:true"/>
								</td>
								<td class="text_left width0407 redColor">保险</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="insurance" data-options="novalidate:true" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407 redColor">包装费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="packingChargesFee" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">送货上门</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="provideHomeFee" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407 redColor">上楼费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="upstairsFee" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">代收货款</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="collectMoney" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								...
								<td class="text_left width0407 redColor">提货费</td>
							...
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="rejectionFee" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">操作费</td>
								<td><input class="easyui-textbox" type="text" name="operationCostFee" readonly style="width: 200px" data-options="novalidate:true" />
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticeRemarks" readonly data-options="novalidate:true" style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-combobox" type="text" name="ynSettlement" data-options="novalidate:true"  id="jiesuan"
										   style="width: 200px"/>
								</td>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsInvoiceManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsInvoiceManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editlogisticsInvoiceManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditlogisticsInvoiceManagerPage.init();
</script>
</body>
</html>