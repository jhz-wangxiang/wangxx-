        ...
        <div class="column-content0718">
                    ...
                    <div class="leftList marTop20">
                        ...
                        <table cellpadding="5" class="right0407">
                            ...
                            <tr>
                                ...
                                <td><input class="easyui-numberbox" type="text" name="consigneephone1"
                            ...
                            <tr>
                                ...
                                <td><input class="easyui-numberbox" type="text" name="consigneephone2"
                                           data-options="novalidate:true"
                                           style="width: 200px"/>
                                </td>
                            </tr>
            ...
            <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
                <a href="javascript:void(0)" class="easyui-linkbutton"
                   onclick="InsertLlogisticsManagerPage.submitForm()" style="width:80px">提交</a>
                <a href="javascript:void(0)" class="easyui-linkbutton" onclick="InsertLlogisticsManagerPage.clearForm()"
...
<script src='<%=basePath %>js/insertLlogisticsManagerPage.js'></script>
<script>
    var rootPath = '<%=basePath%>';
    InsertLlogisticsManagerPage.init();
</script>
</body>
</html>