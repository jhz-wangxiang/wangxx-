...
<div class="container0718 clearfix">
    <jsp:include page="leftNav.jsp">
    	<jsp:param name="obj" value="swOrderDetail"/>
    </jsp:include>
                ...
                <div class="left ">
                    <table cellpadding="5">
                       <tr>
                           ...
                           <td><span class="text0719" id="robotNum"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text_right">交易时间:</td>
                            <td><span class="text0719" id="createDate"></span></td>
                        </tr>
                        <tr>
                            <td class="text_right">退换货类型:</td>
                            <td><span class="text0719" id="afterSaleState"></span></td>
                        </tr>
                    </table>
                </div>
                <div class="left">
                    <table cellpadding="5" >
                        <tr>
                           <td class="text_right">收货人:</td>
                           <td><span class="text0719" id="consignee"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="text_right">收货地址:</td>
                            <td class="address-info0722"><span class="text0719" id="address"></span></td>
                        </tr>
                        <tr>
                            <td class="text_right">退换货原因:</td>
                            <td class="address-info0722"><span class="text0719" id="refundReasonIndex"></span></td>
                        </tr>
                    </table>
                </div>
                <div class="left">
                    <table cellpadding="5">
                    <tr>
                           <td class="text_right address0722">支付方式:</td>
                           <td class="address-info0722"><span class="text0719" id="payment"></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td class="text_right">购买留言:</td>
                           <td><span class="text0719" id="message"></span></td>
                        </tr>
                        <tr>
                           <td class="text_right">退换货留言:</td>
...
<script src='<%=basePath %>js/swOrderDetail.js'></script>
<script>
