    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    ...
                    <a class="btn reset-btn0718"  href="<%=basePath %>v1/lLogisticsManagerController/logisticsDocManagerPage">跟单信息</a>
            ...
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsDocManagerPage.importExcel(this)"/>
        ...
        <div class="column-content0718">
        	<div class=" content-tool0718 clearfix">
        		...
        		<a href="javascript:LogisticsDocManagerPage.searchDataBySystemManageOrder();" class="btn search-btn0718 excle-btn0405 left">搜索</a>
...
<div id="table-show-condition-window"  title="选择显示信息">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'">
            ...
            <div class="displayBox selBox0516">
                ...
                <ul id="orderCkUl">
                    ...
                    <li><input type="checkbox" id="price" value="price" name="check0407" checked class="check"/>金额</li>
                    <li><input type="checkbox" id="remarks" value="remarks" name="check0407" class="check"/>备注</li>
                    <li><input type="checkbox" id="deposit" value="deposit" name="check0407" checked class="check"/>定金</li>
                    ...
                    <input type="hidden" name="order0407" value="11">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="wuLiuCkUl">
                    ...
                    <input type="hidden" name="wuLiu0407" value="2">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="moneyCkUl">
                    <li><input type="checkbox" id="orderStatus" value="orderStatus" name="check0407" class="check" checked/>订单状态</li>
                    <li><input type="checkbox" id="exp14" value="exp14" name="check0407" class="check" checked/>签收时间</li>
                    <li><input type="checkbox" id="exp16" value="exp16" name="check0407" class="check" checked/>拒收（退货）签收</li>
                    <li><input type="checkbox" id="exp17" value="exp17" name="check0407" class="check" checked/>拒收（返货）签收时间</li>
                    <li><input type="checkbox" id="exp2" value="exp2" name="check0407" class="check" checked/>跟单内容</li>
                    <li><input type="checkbox" id="exp1" value="exp1" name="check0407" class="check" checked/>跟单时间</li>
                    ...
                    <input type="hidden" name="money0407" value="6">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="addressCkUl">
                    ...
                    <li><input type="checkbox" id="consigneephone1" value="consigneephone1" name="check0407" checked class="check"/>收货人电话（一）</li>
                    ...
                    <li><input type="checkbox" id="addressDetail" value="addressDetail" name="check0407" checked class="check"/>收货详细地址</li>
                    <input type="hidden" name="address0407" value="3">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    ...
                    <li><input type="checkbox" id="exp25" value="exp25" name="check0407" class="check" checked/>自定义5</li>
                    <li><input type="checkbox" id="exp26" value="exp26" name="check0407" class="check" checked/>自定义6</li>
        ...
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsDocManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsDocManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsDocManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsDocManagerPage.init();
</script>
</body>
</html>