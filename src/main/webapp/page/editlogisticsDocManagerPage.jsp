    ...
    <div class="left content0718">
        <div class="column-content0718">
					...
					<div class="leftList">
						...
						<table cellpadding="5" class="right0407">
							...
							<tr class="lot-tr0606">
								...
								<td class="text_left width0407 redColor">系统平台编号</td>
								<td><input class="easyui-textbox" type="text" name="platformOrder" data-options="novalidate:true" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr class="lot-tr0606">

								<td class="text_left width0407 redColor">收货人电话（一）</td>
								<td><input class="easyui-textbox" type="text" name="consigneephone1" data-options="novalidate:true" readonly style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">收货人详细地址</td>
								<td><input class="easyui-textbox" type="text" name="addressDetail" multiline="true" data-options="novalidate:true" readonly style="width: 200px;height:120px"/>
								</td>
							</tr>
							<tr class="lot-tr0606">
								<td class="text_left width0407 redColor">物流单号</td>
								<td><input class="easyui-textbox" type="text" name="logisticsNumber" readonly data-options="novalidate:true" style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">超派费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="superChargeFee" data-options="novalidate:true" readonly style="width: 200px"/>
								</td>
							</tr>
							<tr class="lot-tr0606">
								<td class="text_left width0407 redColor">金额</td>
								<td><input class="easyui-numberbox" type="text" name="price" precision="2" readonly data-options="novalidate:true" style="width: 200px"/>
								</td>
								<td class="text_left width0407 redColor">定金</td>
								<td><input class="easyui-numberbox" type="text" name="deposit" precision="2" readonly data-options="novalidate:true" style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">订单状态</td>
								<td><input class="easyui-combobox" type="text" name="orderStatus" id="orderStatus" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
					...
					<div class="leftList" style="display: none">
						...
						<table cellpadding="5" class="right0407">
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticsStatus" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticsCompany"
										   data-options="validType:['maxLength[50]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="logisticeFee" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">运费</td>
								<td><input class="easyui-numberbox" type="text" name="freightFee" precision="2" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">中转费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="transitFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">保险</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="insurance"
										   data-options="validType:['maxLength[50]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="packingChargesFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">送货上门</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="provideHomeFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">上楼费</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="upstairsFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">代收货款</td>
								<td><input class="easyui-numberbox" precision="2" type="text" name="collectMoney" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="rejectionFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">操作费</td>
								<td><input class="easyui-textbox" type="text" name="operationCostFee"
										   style="width: 200px"
										   data-options="validType:['maxLength[50]'],novalidate:true"/>
								</td>
							</tr>
							<tr>
								...
								<td><input class="easyui-numberbox" precision="2" type="text" name="otherFee" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">物流备注</td>
								<td><input class="easyui-textbox" type="text" name="logisticeRemarks"
										   data-options="validType:['maxLength[50]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">费用承担</td>
								<td><input class="easyui-textbox" type="text" name="exp8"
										   data-options="validType:['maxLength[100]'],novalidate:true"
										   style="width: 200px"/>
								</td>
								<td class="text_left width0407">付款方式</td>
								<td><input class="easyui-textbox" type="text" name="exp9"
										   data-options="validType:['maxLength[100]'],novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
					...
					<div class="leftList" style="display: none">
						...
						<table cellpadding="5" class="right0407" >
							...
							<tr>
								...
								<td><input class="easyui-textbox" type="text" name="orderDecision" readonly data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
					...
					<div class="leftList marTop20" style="display: none">
						...
						<table cellpadding="5" class="right0407">
							<tr>
								...
								<td><input class="easyui-combobox" type="text" name="ynPayment" id="huikuan" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
								<td class="text_left width0407">回款金额</td>
								<td><input class="easyui-numberbox" type="text" name="collectionPrice" precision="2" data-options="novalidate:true"
										   style="width: 200px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="easyui-combobox" type="text" name="ynSettlement"  id="jiesuan"
										   data-options="novalidate:true"	   style="width: 200px"/>
								</td>
							</tr>
							<tr>
           ...
           <div style="text-align:center;padding:5px 0;margin-bottom:40px;">
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsDocManagerPage.submitForm()" style="width:80px">提交</a>
            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="EditlogisticsDocManagerPage.clearForm()" style="width:80px">清空</a>
		   </div>
        </div>
    </div>
</div>
...
<script src='<%=basePath %>js/editlogisticsDocManagerPage.js'></script>
<script>
var rootPath='<%=basePath%>';
EditlogisticsDocManagerPage.init();
</script>
</body>
</html>