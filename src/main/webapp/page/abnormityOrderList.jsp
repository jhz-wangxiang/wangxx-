...
<jsp:include page="_menu.jsp">
	<jsp:param value="abnormity" name="classify"/>
	<jsp:param value="abnormity_list" name="level"/>
</jsp:include>
        ...
        <article class="cl pd-20">
            <form action="" method="post" class="form form-horizontal layui-form" id="form-admin-add">
                    <div class="row cl">
                        ...
                        <div class="row cl">
                        <div class="col-xs-12 col-sm-6 col-md-4 mb-10" style="display: none;">
...
<script type="text/javascript">
    ...
    layui.use(['form','table'],function(){
    	...
    	tableIns = table.render({
    		...
    		method:"POST",
    		where: {start:start,abnormalStatus:'是'},
