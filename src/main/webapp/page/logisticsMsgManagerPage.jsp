    ...
    <div class="left content0718">
        <div class="column-content0718">
            <div class="content-tool0718 clearfix">
                <div class="left">
                    ...
                    <a class="btn reset-btn0718 " href="<%=basePath %>v1/lLogisticsManagerController/logisticsMsgManagerPage">物流信息</a>
                    ...
                    <a class="btn search-btn0718"  href="<%=basePath %>v1/lLogisticsManagerController/logisticsInvoiceManagerPage">发票信息</a>
                </div>
            </div>
            <div class="content-tool0718 clearfix">
                ...
                <div class="right" id="opera0710">
                    ...
                    <input type="file" id="file" name="file" onchange="LogisticsMsgManagerPage.importExcel(this)"/>
        ...
        <div class="column-content0718">
        	<div class=" content-tool0718 clearfix">
        		...
        		<a href="javascript:LogisticsMsgManagerPage.searchDataBySystemManageOrder();" class="btn search-btn0718 excle-btn0405 left">搜索</a>
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'center'">
            ...
            <div class="displayBox selBox0516">
                ...
                <ul id="orderCkUl">
                    <li><input type="checkbox" id="orderDate" value="orderDate" name="check0407" class="check"/>订单日期</li>
                    <li><input type="checkbox" id="sendGoodsType" value="sendGoodsType" name="check0407" class="check"/>发货类型</li>
                    <li><input type="checkbox" id="customerName" value="customerName" name="check0407" class="check"/>客户名称</li>
                    <li><input type="checkbox" id="systemManageOrder1" value="systemManageOrder" name="check0407" class="check" checked/>系统管理订单号</li>
                    ...
                    <li><input type="checkbox" id="clientProperty1" value="clientProperty" name="check0407" class="check"/>客户属性</li>
                    <li><input type="checkbox" id="orderType" value="orderType" name="check0407" class="check"/>订单类型</li>
                    <li><input type="checkbox" id="productCode" value="productCode" name="check0407" class="check"/>产品编码</li>
                    <li><input type="checkbox" id="producutName" value="producutName" name="check0407" class="check"/>产品名称</li>
                    ...
                    <li><input type="checkbox" id="sendGoodsNum" value="sendGoodsNum" name="check0407" class="check"/>发货数量</li>
                    <li><input type="checkbox" id="unitPrice" value="unitPrice" name="check0407" class="check"/>单价</li>
                    <li><input type="checkbox" id="price" value="price" name="check0407" class="check"/>金额</li>
                    ...
                    <input type="hidden" name="order0407" value="0">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="wuLiuCkUl">
                    ...
                    <li><input type="checkbox" id="warehouseLocation" value="warehouseLocation" name="check0407" class="check" checked/>出库库位</li>
                    <li><input type="checkbox" id="logisticsCompany" value="logisticsCompany" name="check0407" class="check" checked/>物流公司</li>
                    <li><input type="checkbox" id="logisticsNumber" value="logisticsNumber" name="check0407" class="check" checked/>物流单号</li>
                    <li><input type="checkbox" id="logisticeFee" value="logisticeFee" name="check0407" class="check" checked/>物流费用</li>
                    <li><input type="checkbox" id="freightFee" value="freightFee" name="check0407" class="check" checked/>运费</li>
                    <li><input type="checkbox" id="insurance" value="insurance" name="check0407" class="check" checked/>保险</li>
                    <li><input type="checkbox" id="transitFee" value="transitFee" name="check0407" class="check" checked/>中转费</li>
                    <li><input type="checkbox" id="provideHomeFee" value="provideHomeFee" name="check0407" class="check" checked/>送货上门</li>
                    <li><input type="checkbox" id="packingChargesFee" value="packingChargesFee" name="check0407" class="check" checked/>包装费</li>
                    <li><input type="checkbox" id="collectMoney" value="collectMoney" name="check0407" class="check" checked/>代收货款</li>
                    <li><input type="checkbox" id="upstairsFee" value="upstairsFee" name="check0407" class="check" checked/>上楼费</li>
                    <li><input type="checkbox" id="superChargeFee" value="superChargeFee" name="check0407" class="check" checked/>超派费</li>
                    <li><input type="checkbox" id="deliveryFee" value="deliveryFee" name="check0407" class="check" checked/>提货费</li>
                    <li><input type="checkbox" id="rejectionFee" value="rejectionFee" name="check0407" class="check" checked/>拒收退回费</li>
                    <li><input type="checkbox" id="operationCostFee" value="operationCostFee" name="check0407" class="check" checked/>操作费</li>
                    <li><input type="checkbox" id="otherFee" value="otherFee" name="check0407" class="check" checked/>其他</li>
                    <li><input type="checkbox" id="logisticeRemarks" value="logisticeRemarks" name="check0407" class="check" checked/>物流备注</li>
                    <li><input type="checkbox" id="exp8" value="exp8" name="check0407" class="check" checked/>费用分类</li>
                    <li><input type="checkbox" id="exp9" value="exp9" name="check0407" class="check" checked/>付款方式</li>
                    <li><input type="checkbox" id="exp19" value="exp19" name="check0407" class="check" checked/>机器人SN</li>
                    <li><input type="checkbox" id="exp18" value="exp18" name="check0407" class="check" checked/>充电桩SN</li>
                    <input type="hidden" name="wuLiu0407" value="21">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="moneyCkUl">
                    ...
                    <li><input type="checkbox" id="exp13" value="exp13" name="check0407" class="check"/>发票类型</li>
                    <li><input type="checkbox" id="exp3" value="exp3" name="check0407" class="check"/>发票抬头</li>
                    <li><input type="checkbox" id="exp4" value="exp4" name="check0407" class="check"/>发票快递单号</li>
                    <li><input type="checkbox" id="exp5" value="exp5" name="check0407" class="check"/>发票发送日期</li>
                    <input type="hidden" name="money0407" value="0">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="addressCkUl">
                    <li><input type="checkbox" id="consigneeName1" value="consigneeName1" name="check0407" class="check"/>收货人姓名（一）</li>
                    ...
                    <input type="hidden" name="address0407" value="0">
                </ul>
            </div>
            <div class="displayBox selBox0516">
                ...
                <ul id="definedCkUl" class="defineUl0414">
                    ...
                    <li><input type="checkbox" id="exp23" value="exp23" name="check0407" class="check" checked/>自定义3</li>
                    <li><input type="checkbox" id="exp24" value="exp24" name="check0407" class="check" checked/>自定义4</li>
                    ...
                    <li><input type="checkbox" id="exp31" value="exp31" name="check0407" class="check"/>发票号</li>
                    <li><input type="checkbox" id="ex32" value="ex32" name="check0407" class="check"/>自定义12</li>
                    <li><input type="checkbox" id="exp33" value="exp33" name="check0407" class="check"/>自定义13</li>
                    <li><input type="checkbox" id="exp34" value="exp34" name="check0407" class="check"/>自定义14</li>
                    <input type="hidden" name="defined0407" value="2">
                </ul>
            </div>
        </div>
        <div data-options="region:'south',border:false" style="text-align:center;padding:5px 0;height: 35px;">
            <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)" onclick="LogisticsMsgManagerPage.clearSelTabHeader()">清空</a>
            <a class="easyui-linkbutton " data-options="iconCls:'icon-ok'" style="margin-left: 10px;" href="javascript:void(0)" onclick="LogisticsMsgManagerPage.submitTableHeader()">提交</a>
        </div>
    </div>
...
<script src='<%=basePath %>js/logisticsMsgManagerPage.js'></script>
<script>
    var rootPath='<%=basePath%>';
    LogisticsMsgManagerPage.init();
