 ...
 * 查看跟单信息
 */
var EditlogisticsDocManagerPage=function () {
    /*批量修改隐藏不可以修改的列*/
    ...
    return {
        ...
        submitForm:function () {
            var url='v1/lLogisticsManagerController/updateLogisticsDocManager?';
            if(GetEditLogisticsData.constantVar=='l'){
                ...
                success:function (res) {
                    ...
                    if(res.resultCode=="SUCCESS"){
                        $.messager.alert('提示信息',res.msg,'info',function () {
                            location.href=rootPath+'v1/lLogisticsManagerController/logisticsDocManagerPage';
                        });
                    }else{
