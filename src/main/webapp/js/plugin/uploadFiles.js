jQuery.extend({
    ...
    ajaxFileUpload: function(s) {
        ...
        var h = [];
		h.push('<div id="load"><div class="cover" style="z-index:90"></div><div class="ball-spin-fade-loader"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div>');
		$("body").append($(h.join("")));
        var xml = {}   
        if ( s.global )
